...
soilArea = MV2.concatenate((MV2.array(fgs1('soil_area')), MV2.array(fgs2('soil_area')), MV2.array(fgs3('soil_area')), MV2.array(fgs4('soil_area')), MV2.array(fgs5('soil_area')), MV2.array(fgs6('soil_area'))),axis=1)
...
def getWebsiteVariablesDic():
  ...
  varDic = pickle.load(open("/home/fms/local/opt/fre-analysis/test/eem/code/cm4_web_analysis/etc/LM3_variable_dictionary", 'rb'))
  return varDic
